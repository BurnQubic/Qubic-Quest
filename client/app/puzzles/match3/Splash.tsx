...
function Logo() {
  ...
  return (
    <AnimatedCenter {...props}>
      ...
      >
        {`shiny\nstones`}
        <meshPhysicalMaterial roughness={0.2} color="#efa7d6" reflectivity={0.8} metalness={1} />
      </Text3D>
    </AnimatedCenter>
  );
}
    ...
    <View style={styles.container}>
      <Canvas shadows>
        ...
        <Suspense fallback={null}>
          ...
          <a.mesh position-y={0.2} position-x={0.5} scale={8} receiveShadow {...props}>
            <torusKnotGeometry args={[0.8, 0.1, 100, 16]} />
            <meshPhysicalMaterial attach="material" color="gold" metalness={0.1} roughness={0.1} reflectivity={0.1} />
          </a.mesh>
        </Suspense>
